...
const ProductRow = ({ classes, api, Link }) => (
  <TableRow>
    <TableCell>
...
const ApiSelectList = ({ classes, product, apiList, newSelectApi, apiAddingInProgress, addApiStarted, changeNewApi, Link = LinkContainer }) => (
